        ...
        <form id={'disable-totp-form'} className={'mt-6'} onSubmit={submit}>
            ...
            <Dialog.Footer>
                ...
                <Tooltip
                    ...
                    content={'Musisz podać hasło do swojego konta, aby kontynuować.'}
                >
...
export default asDialog({
    ...
    description: 'Wyłączenie weryfikacji dwuetapowej sprawi, że Twoje konto będzie mniej bezpieczne.',
})(DisableTOTPDialog);
