...
export default () => {
    ...
    return (
        <ServerContentBlock title={'Ustawienia'}>
            <FlashMessageRender byKey={'settings'} css={tw`mb-4`} />
            <div css={tw`md:flex`}>
                <div css={tw`w-full md:flex-1 md:mr-10`}>
                    <Can action={'file.sftp'}>
                        <TitledGreyBox title={'Dane SFTP'} css={tw`mb-6 md:mb-10`}>
                            <div>
                            ...
                            <div css={tw`mt-6 flex items-center`}>
                                ...
                                <div css={tw`ml-4`}>
                                    <a href={`sftp://${username}.${id}@${ip(sftp.ip)}:${sftp.port}`}>
                                        <Button.Text variant={Button.Variants.Secondary}>Uruchom SFTP</Button.Text>
                                    </a>
                                </div>
                            </div>
                        </TitledGreyBox>
                    </Can>
                    <TitledGreyBox title={'Informacje debugowania'} css={tw`mb-6 md:mb-10`}>
