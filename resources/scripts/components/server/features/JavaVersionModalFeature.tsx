...
const JavaVersionModalFeature = () => {
    ...
    return (
        ...
        >
            ...
            <h2 css={tw`text-2xl mb-4 text-neutral-100`}>Nieobsługiwana wersja Java</h2>
            <p css={tw`mt-4`}>
                Ten serwer działa obecnie na nieobsługiwanej wersji Java i nie może zostać uruchomiony.
                <Can action={'startup.docker-image'}>
                    &nbsp;Wybierz obsługiwaną wersję z poniższej listy, aby kontynuować uruchamianie serwera.
                </Can>
            </p>
            <Can action={'startup.docker-image'}>
                <div css={tw`mt-4`}>
