                        ...
                        <div css={[tw`flex flex-wrap`, useMoveTerminology ? tw`items-center` : tw`items-end`]}>
                            <div css={tw`w-full sm:flex-1 sm:mr-4`}>
                                <Field
                                    ...
                                    description={
                                        useMoveTerminology
                                            ? 'Podaj nową nazwę i katalog pliku lub folderu względem bieżącego katalogu.'
                                            : undefined
                                    }
                                    autoFocus
                                />
                            ...
                            <div css={tw`w-full sm:w-auto mt-4 sm:mt-0`}>
                                <Button css={tw`w-full`}>{useMoveTerminology ? 'Przenieś' : 'Zmień nazwę'}</Button>
                            </div>
                        </div>
                        {useMoveTerminology && (
                            <p css={tw`text-xs mt-2 text-neutral-400`}>
                                <strong css={tw`text-neutral-200`}>Nowa lokalizacja:</strong>
