    ...
    return (
        <div className={'space-y-2 mt-6'}>
            ...
            <Dialog.Footer>
                ...
                <Button.Text onClick={close}>Zamknij</Button.Text>
            </Dialog.Footer>
        </div>
    );
};
...
const FileUploadListDialog = asDialog({
    ...
    description: 'Następujące pliki są przesyłane na Twój serwer.',
})(FileUploadList);
...
export default () => {
    ...
    return (
        <>
            {count > 0 && (
                <Tooltip content={`${count} plików jest przesyłanych, kliknij aby zobaczyć`}>
                    <button
